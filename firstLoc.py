...
from Detector.export_reading_in_file import export_reading_in_file ,export_reading_in_file2 ,export_reading_in_file_occupied,export_reading_in_file_occupied2
...
# ---------------------------------------------------------------------------------------------
    ...
    if playing == False:
        print("The First Location Has Been Scanned")# when the video finishes
        break
...
#--------------------------------------------------------------------------------------
    ...
    export_reading_in_file_occupied(array_of_occupied_spaces)
